/// Adapted from https://github.com/migueldeicaza/SwiftTerm/blob/main/Sources/SwiftTerm/Pty.swift by Miguel de Icaza
...
public enum PseudoTerminalHelpers {
	 ...
	 */
	public static func fork(andExec: String, args: [String], env: [String], workingDirectory: String? = nil, desiredWindowSize: inout winsize) -> (pid: pid_t, masterFd: Int32)?
	{
		var master: Int32 = 0
